...
El fichero [`colesterol.csv`]('https://raw.githubusercontent.com/asalber/manual-r/master/datos/colesterol.csv') contiene información de una muestra de pacientes donde se han medido la edad, el sexo, el peso, la altura y el nivel de colesterol, además de su nombre.

a. Crear un data frame con los datos de todos los pacientes del estudio a partir del fichero [`colesterol.csv`](('https://raw.githubusercontent.com/asalber/manual-r/master/datos/colesterol.csv')).
...
Se ha diseñado un ensayo clínico leatorizado, doble-ciego y controlado con placebo, para estudiar el efecto de dos alternativas terapéuticas en el control de la hipertensión
...
a. Crear un data frame con los datos de los pacientes del hospital A (fichero de Excel [datos-hospital-a.xls](datos/hipertension/datos-hospital-a.xls)).
...
b. Crear un data frame con los datos de los pacientes del hosptial B (fichero csv [datos-hospital-b.csv](datos/hipertension/datos-hospital-b.csv)).
