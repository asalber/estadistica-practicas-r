...
a.  Calcular el modelo de regresión sigmoidal del peso perdido sobre los días de dieta. ¿Es un buen modelo para explicar la relación entre el peso perdido y los días de dieta?
    ...
    El modelo de regresión sigmoidal que mejor explica el peso perdido en función de los días de dieta es $\textsf{Peso}= e^{`r sigmoidal_peso_dias$coefficients[["(Intercept)"]]` `r sigmoidal_peso_dias$coefficients[["I(1/dias)"]]` / \textsf{dias}}$.
    :::
